        ...
        {draft.loading ? (
          ...
          <>
            <textarea value={draft.text} onChange={(e) => setDraft((d) => ({ ...d, text: e.target.value }))}
              className="h-48 w-full resize-none rounded-xl border border-field-border bg-field p-3.5 text-sm leading-relaxed text-fg outline-none focus:border-aurora-violet/50" />
