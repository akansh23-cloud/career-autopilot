          ...
          {isAdmin && <SectionCard title="Candidate shortlist" eyebrow="Admin / Recruiter-safe">
            <div className="mb-3 flex flex-wrap items-center gap-2">
              <div className="relative flex-1 min-w-[160px]">
                ...
                <input value={skill} onChange={(e) => setSkill(e.target.value)} placeholder="Filter by verified skill…" className="h-9 w-full rounded-lg border border-subtle bg-surface-1 pl-9 pr-3 text-xs text-fg outline-none" />
              </div>
              <div className="relative">
                <select value={category} onChange={(e) => setCategory(e.target.value)} className="h-9 cursor-pointer appearance-none rounded-lg border border-subtle bg-surface-1 pl-3 pr-8 text-xs text-fg outline-none">
