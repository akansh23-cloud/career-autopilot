      ...
      <div className="grid gap-4 lg:grid-cols-[1fr_1.4fr]">
        <SectionCard title="Describe your project">
          ...
          <div className="mt-3"><Field label="Description">
            <textarea value={form.description} onChange={f('description')} placeholder="What does it do? Any scale, auth, async or AI needs?" className="h-24 w-full resize-none rounded-xl border border-field-border bg-field p-3 text-sm text-fg outline-none focus:border-aurora-violet/50" />
          </Field></div>
