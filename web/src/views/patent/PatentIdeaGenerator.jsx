      ...
      <div className="grid gap-4 lg:grid-cols-[1fr_1.4fr]">
        <SectionCard title="Inputs">
          ...
          <div className="mt-3"><Field label="Problem statement">
            <textarea value={form.problem} onChange={f('problem')} placeholder="What real problem should the invention solve?" className="h-20 w-full resize-none rounded-xl border border-subtle bg-surface-1 p-3 text-sm text-fg outline-none focus:border-aurora-violet/50" />
          </Field></div>
