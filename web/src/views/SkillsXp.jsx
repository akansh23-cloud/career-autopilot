      ...
      {showForm && (
        <SectionCard title="Submit project for verification" className="mb-4">
          <div className="grid gap-3 sm:grid-cols-2">
            ...
            <Field label="Complexity">
              <div className="relative">
                <select value={form.complexityLevel} onChange={f('complexityLevel')} className="h-11 w-full cursor-pointer appearance-none rounded-xl border border-subtle bg-surface-1 px-3.5 pr-10 text-sm text-fg outline-none focus:border-aurora-violet/50">
          ...
          <div className="mt-3"><Field label="What you built / outcome">
            <textarea value={form.outcome} onChange={f('outcome')} placeholder="Describe what you built and measurable impact…" className="h-24 w-full resize-none rounded-xl border border-subtle bg-surface-1 p-3 text-sm text-fg outline-none focus:border-aurora-violet/50" />
          </Field></div>
