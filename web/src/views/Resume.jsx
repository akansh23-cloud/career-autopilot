  ...
  if (!max) {
    ...
    return (
      <div className="flex items-center justify-between text-[12px]">
        ...
        <span className="tabular-nums text-danger">{value}</span>
      </div>
    );
  }
        ...
        <SectionCard title="Your resume">
          ...
          <div
            ...
            className={`mt-3 flex cursor-pointer flex-col items-center justify-center gap-2 rounded-xl border border-dashed px-4 py-6 text-center transition ${
              drag ? 'border-aurora-violet/60 bg-aurora-violet/10' : 'border-subtle bg-surface-1 hover:border-strong'
            }`}
          >
            {parsing ? (
          ...
          <textarea
            ...
            className="mt-3 h-56 w-full resize-none rounded-xl border border-field-border bg-field p-4 text-sm leading-relaxed text-fg outline-none placeholder:text-fg-muted focus:border-aurora-violet/50"
          />
