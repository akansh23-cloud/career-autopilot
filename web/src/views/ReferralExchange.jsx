          ...
          <div className="space-y-4">
            ...
            <Field label="Your message">
              <textarea value={reqMsg} onChange={(e) => setReqMsg(e.target.value)} rows={5}
                className="w-full rounded-xl border border-field-border bg-field px-3 py-2.5 text-sm text-fg placeholder:text-fg-muted outline-none focus:border-aurora-violet/50"
    ...
    <Modal open={open} onClose={onClose} title="New post" width="max-w-xl">
      <div className="space-y-4">
        <Field label="Post type">
          <select value={t} onChange={(e) => { setT(e.target.value); setVals({}); }} className="h-11 w-full rounded-xl border border-field-border bg-field px-3 text-sm text-fg">
