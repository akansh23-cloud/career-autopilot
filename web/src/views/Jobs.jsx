...
export default function JobsView({ go }) {
  ...
  return <>
    ...
    {toast && (
      <div className="fixed bottom-6 left-1/2 z-50 -translate-x-1/2 rounded-xl border border-aurora-mint/30 bg-menu px-4 py-2.5 text-sm font-medium text-ok shadow-lift backdrop-blur" role="status">
        {toast}
      </div>
    )}
  </>;
