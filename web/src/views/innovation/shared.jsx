...
export function ModeBanner({ mode, aiProvider, warnings = [] }) {
  ...
  return (
    <div className={`rounded-xl border p-3 text-[12.5px] ${limited ? 'border-amber-glow/35 bg-amber-glow/[0.06] text-[#F3E3B2]' : 'border-subtle bg-surface-1 text-fg-secondary'}`}>
