          ...
          <SectionCard title="Job preferences">
            ...
            <div className="mt-3 grid gap-4 sm:grid-cols-3">
              ...
              <Field label="Currency">
                <select value={CURRENCIES.includes(prefs.salaryCurrency) ? prefs.salaryCurrency : 'INR'} onChange={(e) => setPrefs({ ...prefs, salaryCurrency: e.target.value })} className="h-11 w-full rounded-xl border border-subtle bg-base px-3 text-sm text-fg outline-none">
