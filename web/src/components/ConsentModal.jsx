    ...
    <Modal open onClose={() => {}} title="Your data, your call" width="max-w-xl">
      <div className="space-y-4">
        ...
        <ul className="space-y-2 text-[13px] leading-relaxed text-slate-300">
          <li><span className="text-white">What we store:</span> your profile, resumes and their scores, projects and verification evidence, skill XP, patent-workspace drafts, and activity needed to compute your readiness.</li>
          <li><span className="text-white">Why:</span> to score, verify and improve your placement readiness — nothing is sold, and there are no ads.</li>
          <li><span className="text-white">Your rights, built in:</span> download everything from Settings → “Export my data”, and delete your account any time (7-day grace window; signing back in cancels it).</li>
          <li><span className="text-white">Recruiters:</span> see your profile only if you explicitly publish it — that is a separate opt-in, off by default.</li>
        </ul>

        <label className="flex cursor-pointer items-start gap-3 rounded-xl border border-white/10 bg-white/[0.04] p-3 transition hover:bg-white/[0.06]">
          <input
            type="checkbox"
          ...
          <span className="text-[13px] leading-relaxed text-slate-300">
            <span className="font-medium text-white">Share my readiness with my college's placement cell.</span>{' '}
        ...
        <div className="flex items-center justify-between gap-3 pt-1">
          <p className="text-[11px] text-slate-500">Consent version {consentVersion}. Full policy: <a href="#/legal/privacy" className="text-slate-400 underline underline-offset-2 hover:text-white">Privacy</a> · <a href="#/legal/terms" className="text-slate-400 underline underline-offset-2 hover:text-white">Terms</a></p>
