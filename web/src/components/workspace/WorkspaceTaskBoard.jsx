      ...
      {isBlocking ? (
        <div className="mt-2.5 space-y-2">
          <input
            ...
            className="h-9 w-full rounded-lg border border-field-border bg-field px-3 text-[12.5px] text-fg outline-none focus:border-aurora-violet/40"
          />
          <div className="flex gap-2">
            <button
              className="rounded-lg bg-rose-500/20 px-3 py-1.5 text-[12px] font-medium text-danger hover:bg-rose-500/30"
              onClick={() => {
            ...
            <button
              className="rounded-lg bg-surface-1 px-3 py-1.5 text-[12px] text-fg-secondary hover:bg-surface-2"
        ...
        <div className="mt-2.5 flex items-center gap-2">
          <div className="relative flex-1">
            <select
              ...
              className="h-9 w-full cursor-pointer appearance-none rounded-lg border border-field-border bg-field px-2.5 pr-7 text-[12px] text-fg outline-none focus:border-aurora-violet/40 disabled:cursor-not-allowed disabled:text-fg-muted"
            >
              {USER_STATUSES.map((s) => (
          ...
          {shown.map((col) => (
            ...
            >
              ...
              <header className="mb-2.5 flex shrink-0 items-center justify-between px-1">
                ...
                <span className="rounded-full bg-surface-1 px-2 py-0.5 font-mono text-[10.5px] text-fg-secondary">
                  {cols[col.id].length}
                </span>
              </header>
