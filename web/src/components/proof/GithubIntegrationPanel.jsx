      ...
      {notConfigured ? (
        ...
        <div className="space-y-4">
          ...
          {!connected ? (
            <div className="rounded-2xl border border-subtle bg-surface-1 p-4">
              <div className="flex items-center gap-3">
                <span className="grid h-11 w-11 place-items-center rounded-2xl bg-surface-1 text-fg ring-1 ring-strong"><Github size={20} /></span>
            ...
            <div className="rounded-2xl border border-aurora-mint/25 bg-aurora-mint/[0.04] p-4">
              <div className="flex flex-wrap items-start justify-between gap-3">
                <div className="flex items-center gap-3">
                  {conn.avatarUrl
                    ? <img src={conn.avatarUrl} alt="" className="h-11 w-11 rounded-2xl ring-1 ring-strong" />
                    : <span className="grid h-11 w-11 place-items-center rounded-2xl bg-surface-1 text-fg ring-1 ring-strong"><Github size={20} /></span>}
                  <div>
          ...
          <div className="rounded-2xl border border-subtle bg-surface-1 p-4">
            <div className="flex flex-wrap items-start justify-between gap-3">
              <div className="flex items-center gap-3">
                <span className="grid h-11 w-11 place-items-center rounded-2xl bg-aurora-violet/15 text-aurora-cyan ring-1 ring-strong"><PlugZap size={20} /></span>
                <div className="min-w-0">
