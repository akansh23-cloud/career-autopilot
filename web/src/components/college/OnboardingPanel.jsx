  ...
  return (
    <SectionCard title="Roster import" eyebrow="Paste or upload your placement-cell student list (CSV)" icon={FileSpreadsheet}>
      ...
      <textarea
        ...
        rows={5}
        className="w-full rounded-xl border border-subtle bg-surface-1 p-3 font-mono text-[12px] text-fg placeholder:text-fg-muted focus:border-aurora-violet/50 focus:outline-none"
      />
